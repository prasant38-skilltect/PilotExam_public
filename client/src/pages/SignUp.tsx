...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-purple-800 flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-lg bg-white/95 backdrop-blur-sm border-0 shadow-2xl relative z-10 my-8">
        <CardHeader className="text-center pb-4">
          ...
          <p className="text-gray-600 mt-2">Start your aviation journey today</p>
        </CardHeader>
